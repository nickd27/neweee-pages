...
(function(){
  ...
  uk: 'Етапи процесу'
    ...
    // --- Services ---
    services:{
      ru:{h1:'Наши компетенции и направления',p:'Мы — команда инженеров и исследователей, специализирующаяся на инженерном консалтинге в энергетических проектах (ТЭС), решении сложных производственно-промышленных задач методами ФСА и ТРИЗ, а также лабораторных исследованиях различных полей и испытаниях прототипов.',i1h:'Энергетический инжиниринг',i1p:'Технические решения для энергетических объектов: основное оборудование,градирни, тепловые схемы, ТЭО и проектирование, повышение энергоэффективности.',i2h:'ФСА / ТРИЗ',i2p:'Функционально-стоимостной анализ и методология ТРИЗ: снижение себестоимости, устранение противоречий, портфель практичных решений.',i3h:'Лабораторные исследования',i3p:'Экспериментальная отработка идей и прототипов: стендовые испытания, измерения, документирование результатов.',more:'Подробнее →'},
      en:{h1:'Our competencies & services',p:'We are a team of engineers and researchers focused on consulting for power projects (thermal plants), solving complex industrial challenges with FVA/TRIZ, and running laboratory studies and prototype tests.',i1h:'Energy Engineering',i1p:'Solutions for power facilities: basic equipement, cooling towers, thermal schemes, feasibility and design, higher efficiency.',i2h:'FVA / TRIZ',i2p:'Function–value analysis & TRIZ: cost reduction, contradiction removal, practical portfolio.',i3h:'Laboratory Research',i3p:'Experimental validation of ideas and prototypes: bench tests, measurements, documentation.',more:'Learn more →'},
      uk:{h1:'Наші компетенції та напрями',p:'Ми — команда інженерів і дослідників, що спеціалізується на консалтингу для енергетичних проєктів (ТЕС), розв’язанні складних виробничих задач методами ФВА/ТРІЗ і лабораторних дослідженнях та випробуваннях прототипів.',i1h:'Енергетичний інжиніринг',i1p:'Рішення для енергетичних об’єктів: основне обладнання, градирні, теплові схеми, ТЕО і проєктування, підвищення ефективності.',i2h:'ФВА / ТРІЗ',i2p:'Функціонально-вартісний аналіз і ТРІЗ: зниження собівартості, усунення протиріч, практичний портфель.',i3h:'Лабораторні дослідження',i3p:'Експериментальна відпрацювання ідей і прототипів: стендові випробування, вимірювання, документація.',more:'Детальніше →'}
    },

    // --- Publications ---
    publications:{
      ru:{h1:'Публикации и статьи',lead:'Здесь собраны наши материалы: технические публикации (PDF) и авторские статьи.',a1h:'«Практика применения ФСА на примере конструкции вентиляторной градирни»',a1p:'Кейс-описание этапов ФСА на конкретном объекте: поиск и формулировка функций, моделирование системы, выявление зоны избыточных затрат, анализ технических противоречий и портфель эффективных решений для снижения себестоимости.',a2h:'«Испарительные градирни в энергетике. Актуальные проблемы и возможные решения»',a2p:'Обзор проблем эксплуатации и подходов к их решению: гидравлика, теплообмен, новые технические решения и модернизация, влияние на CAPEX/OPEX.',read:'Читать статью (PDF)',download:'Скачать PDF',
        a3h:'«Основы технологии системного мышления»',
        a3p:'Книга о структуре, основе, методах и практиках использования системного мышления для решения сложных задач. Глубокая и развернутая работа Евгения Голибардова — авторитетного специалиста ФСА и ТРИЗ, автора многих книг и публикаций, заслуженного деятеля культуры Польши.'
      },
      en:{h1:'Publications & Articles',lead:'Our materials: technical publications (PDF) and in-house articles.',a1h:'“FVA Practice on a Forced-Draft Cooling Tower”',a1p:'Case study of FVA: search and formulation of functions, system modeling, identification of areas of excessive costs, technical contradictions, and portfolio of effective solutions for reducing production costs.',a2h:'“Evaporative Cooling Towers in Power. Issues and Possible Solutions”',a2p:'Operating issues and approaches: hydraulics, heat transfer, new technical solutions and modernization, CAPEX/OPEX impact.',read:'Read article (PDF)',download:'Download PDF',
        a3h:'“Basics of Systems Thinking Technology”',
        a3p:'A book on the structure, foundations, methods and practices of systems thinking for solving complex problems. A deep, comprehensive work by Yevgeniy Golibardov — a recognized expert in FVA and TRIZ, author of many books and publications, and a Merited Cultural Figure of Poland.'
      },
      uk:{h1:'Публікації та статті',lead:'Тут зібрані наші матеріали: технічні публікації (PDF) та авторські статті.',a1h:'«Практика ФВА на прикладі конструкції вентиляторної градирні»',a1p:'Кейс: пошук та формулювання функцій, моделювання системи, знаходження зони надлишкових витрат, технічні протиріччя і портфель ефективних рішень для зниження собівартості.',a2h:'«Випарні градирні в енергетиці. Актуальні проблеми і рішення»',a2p:'Проблеми експлуатації і підходи до їх вирішення: гідравліка, теплообмін, нові технічні рішення і модернізація, вплив на CAPEX/OPEX.',read:'Читати статтю (PDF)',download:'Завантажити PDF',
        a3h:'«Основи технології системного мислення»',
        a3p:'Книга про структуру, засади, методи та практики системного мислення для розв’язання складних задач. Глибока й розгорнута праця Євгенія Голібардова — визнаного фахівця з ФВА та ТРВЗ, автора численних книг і публікацій, заслуженого діяча культури Польщі.'
      }
    },
